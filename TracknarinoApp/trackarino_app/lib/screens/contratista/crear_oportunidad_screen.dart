...
class CrearOportunidadScreen extends StatefulWidget {
  ...
  const CrearOportunidadScreen({super.key, this.onOportunidadCreada});
...
class _CrearOportunidadScreenState extends State<CrearOportunidadScreen> {
  ...
  void initState() {
    ...
    _descripcionController.text =
        "Se requiere transportar productos agrícolas frescos";
  ...
  Future<void> _crearOportunidad() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final double? precioParsed = double.tryParse(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Crear Oportunidad')),
      body:
          _isLoading
